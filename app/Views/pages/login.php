                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 d-none d-lg-flex align-items-center order-2 order-lg-1">
                            <div class="p-3 p-lg-5">
                                <img src="assets/images/element/signin.svg" alt="" class="img-fluid">
                            </div>
                            <!-- Divider -->
                            ...
                            <div class="p-4 p-sm-5">
                                ...
                                <form class="mt-4">
                                    ...
                                    <div class="mb-3 d-sm-flex justify-content-between align-items-center">
                                        ...
                                        <a href="forgot-password.html" class="mt-2 mt-sm-0">Forgot password?</a>
                                    </div>
                                    <!-- Button -->
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="<?= site_url('login/google') ?>" class="btn btn-light"><i class="fab fa-fw fa-google text-google-icon me-2"></i>Sign in with Google</a>
                                        <a href="#" class="btn btn-light"><i class="fab fa-fw fa-facebook-f text-facebook me-2"></i>Sign in with Facebook</a>
                                    </div>
